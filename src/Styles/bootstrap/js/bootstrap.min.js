...
+(function(t) {
  ...
  (i.VERSION = "3.3.7"), (i.prototype.toggle = function(o) {
    ...
    if (!n.is(".disabled, :disabled")) {
      ...
      if ((r(), !i)) {
        ...
        if (
          ...
          return;
        n.trigger("focus").attr("aria-expanded", "true"), a
          .toggleClass("open")
          .trigger(t.Event("shown.bs.dropdown", d));
      }
      return !1;
    }
    ...
    if (
      ...
      var o = t(this);
      if (
        (r.preventDefault(), r.stopPropagation(), !o.is(".disabled, :disabled"))
      ) {
        var n = e(o),
          i = n.hasClass("open");
        if ((!i && 27 != r.which) || (i && 27 == r.which))
          return 27 == r.which && n.find(a).trigger("focus"), o.trigger(
            "click"
          );
        ...
        if (s.length) {
          ...
          38 == r.which && p > 0 && p--, 40 == r.which &&
            p < s.length - 1 &&
            p++, ~p || (p = 0), s.eq(p).trigger("focus");
        }
      }
    }
  });
